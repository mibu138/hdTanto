...
//
#ifndef TANTO_RENDER_DELEGATE_H
#define TANTO_RENDER_DELEGATE_H
...
///
class HdTantoDelegate final : public HdRenderDelegate 
{
public:
    /// Render delegate constructor. 
    HdTantoDelegate();
    /// Render delegate constructor. 
    HdTantoDelegate(HdRenderSettingsMap const& settingsMap);
    /// Render delegate destructor.
    virtual ~HdTantoDelegate();
...
private:
    ...
    HdTantoDelegate &operator =(const HdTantoDelegate &) = delete;
};
