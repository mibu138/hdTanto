...
//
#ifndef EXTRAS_IMAGING_EXAMPLES_MY_MESH_H
#define EXTRAS_IMAGING_EXAMPLES_MY_MESH_H
...
///
class HdTantoMesh final : public HdMesh 
{
public:
    HF_MALLOC_TAG_NEW("new HdTantoMesh");

    /// HdTantoMesh constructor.
