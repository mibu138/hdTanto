...
//
#ifndef TANTO_PLUGIN_H
#define TANTO_PLUGIN_H
...
///
class HdTantoPlugin final : public HdRendererPlugin 
{
public:
    HdTantoPlugin() = default;
    virtual ~HdTantoPlugin() = default;
...
private:
    ...
    HdTantoPlugin(const HdTantoPlugin&) = delete;
    HdTantoPlugin &operator =(const HdTantoPlugin&) = delete;
};
